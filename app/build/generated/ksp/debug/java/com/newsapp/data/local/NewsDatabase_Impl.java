...
import com.newsapp.data.local.dao.ArticleDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `articles` (`url` TEXT NOT NULL, `sourceId` TEXT, `sourceName` TEXT, `author` TEXT, `title` TEXT NOT NULL, `description` TEXT, `urlToImage` TEXT, `publishedAt` TEXT, `content` TEXT, `category` TEXT NOT NULL, `isBookmarked` INTEGER NOT NULL, `cachedAt` INTEGER NOT NULL, PRIMARY KEY(`url`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '36dce0997cd22704b3526b87a17501ba')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoArticles.equals(_existingArticles)) {
          return new RoomOpenHelper.ValidationResult(false, "articles(com.newsapp.data.local.entity.ArticleEntity).\n"
                  + " Expected:\n" + _infoArticles + "\n"
                  + " Found:\n" + _existingArticles);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "36dce0997cd22704b3526b87a17501ba", "43a8b31d40aa7d57adccf3b668ffa019");
